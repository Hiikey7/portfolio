...
const defaultContent: ContentData = {
  hero: {
    title: "b 3D ANIMATION FOR BRANDS",
    subtitle: "stanpixels",
  ...
  about: {
    title: "About stanpixels creatives",
    description:
  ...
  settings: {
    adminEmail: "admin@thestanpixels.com",
    adminPassword: "1234",
  },
};
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const checkAuth = () => {
      ...
      if (sessionCookie && sessionCookie.includes("authenticated")) {
        ...
        const savedActivity = localStorage.getItem("stanpixels-activity");
        if (savedActivity) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      localStorage.setItem("stanpixels-content", JSON.stringify(content));
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <div className="w-6 h-6 border-2 border-[#3ab3ff] border-t-transparent rounded-full animate-spin"></div>
      </div>
    );
  }
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                className="bg-[#3ab3ff] text-black hover:bg-[#3ab3ff]/90"
              >
          ...
          <Tabs defaultValue="hero" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-neutral-900/50 border border-neutral-800">
              <TabsTrigger
                value="hero"
                className="data-[state=active]:bg-[#3ab3ff]/20 data-[state=active]:text-[#3ab3ff]"
              >
                Hero
              </TabsTrigger>
              <TabsTrigger
              ...
              <Card className="bg-[#1a1a1a] border-neutral-800">
                ...
                <CardContent className="space-y-4">
                  {content.orderForm.formSteps.map((step, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-[#3ab3ff]/20 rounded-full flex items-center justify-center text-[#3ab3ff] font-semibold">
                          {index + 1}
                        </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {content.orderForm.formSteps
                        ...
                        .map((step, index) => (
                          <Badge
                            key={index}
                            className="bg-[#3ab3ff]/20 text-[#3ab3ff] border-[#3ab3ff]/30"
                          >
                            {index + 1}. {step.title}
                          </Badge>
                        ))}
                ...
                <Button
                  ...
                  onClick={() => {
                    if (
                      ...
                      localStorage.removeItem("stanpixels-content");
                      localStorage.removeItem("stanpixels-activity");
            ...
            <Card className="bg-[#1a1a1a] border-neutral-800">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[#3ab3ff] rounded-full flex items-center justify-center text-black text-sm font-bold">
                    1
                  </div>
                  <div>
          ...
          <div className="absolute left-0 top-0 h-full w-64 bg-[#0f0f0f] border-r border-neutral-800">
            <div className="p-6 border-b border-neutral-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-semibold">stanpixels</span>
              </div>
              <Button
                variant="ghost"
                size="sm"
