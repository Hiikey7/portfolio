...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Default credentials
      if (
        (email === "admin@thestanpixels.com" && password === "1234") ||
        (email === "Addy@thestanpixels.com" && password === "1234")
      ) {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12">
        ...
        <div className="flex md:hidden items-center gap-3 mb-8 w-full">
          ...
          <span className="text-2xl font-semibold text-white">stanpixels</span>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="admin@thestanpixels.com"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-sm text-[#3ab3ff] hover:underline"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#3ab3ff] text-black hover:bg-[#3ab3ff]/90"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-8 text-center">
            <p className="text-neutral-400 text-sm">
              Need help? Contact{" "}
              <a
                href="mailto:support@thestanpixels.com"
                className="text-[#3ab3ff] hover:underline"
              >
                support@thestanpixels.com
              </a>
            </p>
          </div>
        </div>
