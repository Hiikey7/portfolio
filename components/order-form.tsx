      ...
      <div className="bg-[#0f0f0f] glass-border-enhanced rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-neutral-800">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-[#3ab3ff]/20 rounded-lg flex items-center justify-center">
              <Package className="h-4 w-4 text-[#3ab3ff]" />
            </div>
            <div>
                ...
                {step < 4 && (
                  <div
                    className={`w-8 h-0.5 mx-2 transition-colors ${
                      step < currentStep ? "bg-[#3ab3ff]" : "bg-neutral-700"
                    }`}
                  />
                )}
              </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-[#3ab3ff]">
                        {order.package?.price}
                      </div>
                    </div>
                  </div>
                    ...
                    <Button
                      ...
                      className={`h-16 ${
                        order.has3DModel === true
                          ? "bg-[#3ab3ff] text-black hover:bg-[#3ab3ff]/90"
                  ...
                  <Card
                    ...
                    className={`cursor-pointer transition-all hover:scale-[1.02] ${
                      order.modelingAddOn?.name === option.name
                        ? "glass-border-enhanced bg-[#3ab3ff]/10"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-[#3ab3ff] font-semibold">
                        ...
                        {order.modelingAddOn?.name === option.name && (
                          <Check className="h-5 w-5 text-[#3ab3ff]" />
                        )}
                      </div>
                    </CardContent>
                  </Card>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              ...
                              {order.renderPackage?.name === option.name && (
                                <Check className="h-4 w-4 text-[#3ab3ff] ml-2 inline" />
                              )}
                            </div>
                          </div>
                        </CardContent>
            ...
            <div className="space-y-6">
              ...
              <Card className="glass-border-subtle border-neutral-800 bg-neutral-900/50">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-3 bg-[#3ab3ff]/10 rounded-lg px-4">
                    <h4 className="text-lg font-bold text-white">Total</h4>
                    <span className="text-2xl font-bold text-[#3ab3ff]">
